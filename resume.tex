...
\begin{ressection}{Employment}
	\begin{restitledposition}{Thirty Madison (Remote)}{Senior Software Engineer II}{April 2022--August 2024}
		\ressubitem{\textbf{Job Runner} Designed, implemented, and maintained a new asynchronous job running solution.}
	\end{restitledposition}
	\begin{restitledposition}{Verikai (Remote)}{Lead Backend Engineer}{November 2021--March 2022}
		\ressubitem{\textbf{Machine Learning Model Development:} Built the next iteration of the ML workflow responsible for processing census files using NodeJS and Typescript.}
		\ressubitem{\textbf{AWS Cloud Solutioning} Worked to create AWS solutions to better position the stack for CI/CD using ECS Fargate.}
	\end{restitledposition}
	\begin{restitledposition}{symplr (Chattanooga, TN)}{Senior Software Engineer}{December 2014--November 2021}
